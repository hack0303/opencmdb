...
import { createAssetMutation, updateAssetMutation } from '@/lib/cmdb/assets/mutations';
import { allTagsOptions } from '@/lib/cmdb/assets/queries';
import type { AssetInstance, AssetTemplate } from '@/lib/cmdb/assets/types';
